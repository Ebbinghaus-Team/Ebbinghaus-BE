...
- **문제 소유권**:
    ...
    - **그룹방 문제 (타인)**: 문제 풀이 시 자동으로 복습 주기에 등록되지 않음. 사용자가 "복습 루프 포함 설정 API"를 호출하여 명시적으로 복습 주기에 추가 가능
...
2.  **그룹 문제 복습 선택**: 다른 멤버의 그룹 문제를 풀어도 자동으로 복습 주기에 등록되지 않습니다. 사용자가 "복습 루프 포함 설정 API"를 통해 명시적으로 복습 주기에 추가할 수 있습니다.
